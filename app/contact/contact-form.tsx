    ...
    <main className="bg-background text-foreground">
      <section className="w-full border-b border-border">
        <div className="mx-auto max-w-6xl px-6 md:px-10 lg:px-16 py-10 md:py-12">
          <h1 className="text-3xl md:text-4xl font-semibold tracking-tight text-pretty"><span className="features-gradient">Contact</span></h1>
      ...
      <section className="mx-auto max-w-2xl px-6 md:px-10 lg:px-16 py-8 md:py-12">
        <form onSubmit={onSubmit} className="grid grid-cols-1 gap-5" aria-label="Contact form">
